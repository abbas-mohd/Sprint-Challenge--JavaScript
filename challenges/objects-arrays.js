...
*/
const lowerPopulation = zooAnimals.filter((smallPop) => {
  return (smallPop.population < 5);
});
...
*/
const populationTotal = zooAnimals.reduce((popTotals, states) => {
  return popTotals + states.population;
}, 0);
